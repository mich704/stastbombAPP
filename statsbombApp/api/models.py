...
class Pass(models.Model):
    ...
    @classmethod
    def create(cls, event_uuid, player, match, type, location_start, location_end, pass_outcome):
...
#     @classmethod
#     def create(cls, event_uuid, player, match, type, location):
#         try:
#             newEvent = cls(
#                 event_uuid = event_uuid,
#                 match = match,
#                 player = player,
#                 type = type,
#                 location_start_X = location[0],
#                 location_start_Y = location[1]
#             )
#         except:
#             newEvent = cls(
#                 match = match,
...
#     def location(self):
#         return [self.location_start_X, self.location_start_Y]
